...
from config import (
    ...
    WILDJAILBREAK_PATH, SCRAPED_LABELED_PATH, AUGMENTED_PATH,
    ID2LABEL, LABEL2ID,
)
from data.dataset import (
    load_stac, load_safetoolbench_dir,
    load_toolsafe_agentharm, load_toolsafe_safetybench,
    load_wildjailbreak, load_scraped_labeled, load_augmented,
...
SOURCES = [
    ...
    ("Augmented",              lambda: load_augmented(AUGMENTED_PATH)
                                       if os.path.exists(AUGMENTED_PATH) else []),
]
